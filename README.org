...
** Fourth Plot
   ...
   #+begin_src R :session yes :file cells_reads.distrib3.png :results graphics file
...
** Fourth Plot
 ...
 :file dot1l-201.exon.distrib.png :results graphics file
   ...
   #+begin_src R :session yes :file cells_reads.distrib4.png :results graphics file
